...
class TestHelpers(unittest.TestCase):
    ...
    def test_is_positive(self):
        ...
        np.testing.assert_array_equal(helpers._is_positive(array), [True, True, False, False])
    ...
    def test_angle_between_vectors(self):
        a = np.array([1, 0])
        b = np.array([0, 1])
        np.testing.assert_almost_equal(helpers.calculate_angle_between_vectors(a, b), 90)
        a = np.array([1, 0])
        b = np.array([1, 0])
        np.testing.assert_almost_equal(helpers.calculate_angle_between_vectors(a, b), 0)
        a = np.array([1, 0])
        b = np.array([-1, 0])
        np.testing.assert_almost_equal(helpers.calculate_angle_between_vectors(a, b), 180)
        a = np.array([1, 0])
        b = np.array([1, 1])
        np.testing.assert_almost_equal(helpers.calculate_angle_between_vectors(a, b), 45)
    ...
    def test_bounding_box_nd(self):
        ...
        self.assertTrue(np.array_equal(helpers._bounding_box_nd(points), np.array([[0, 0], [2, 2]])))
    ...
    def test_find_k_nearest_points(self):
        ...
        k = 1
        self.assertTrue(np.array_equal(helpers._find_k_nearest_points(p, points, k), np.array([0, 0])))
        k = 2
        self.assertTrue(np.array_equal(helpers._find_k_nearest_points(p, points, k), np.array([[0, 0], [-0.5, -0.5]])))
        k = 3
        self.assertTrue(np.array_equal(helpers._find_k_nearest_points(p, points, k), np.array([[0, 0], [-0.5, -0.5], [1, 1]])))
        k = 4
        self.assertTrue(np.array_equal(helpers._find_k_nearest_points(p, points, k), np.array([[0, 0], [-0.5, -0.5], [1, 1], [2, 2]])))
    ...
    def test_compute_intersection(self):
        ...
        p2 = np.array([0, 1])
        q2 = np.array([1, 0])
        self.assertTrue(np.array_equal(helpers._compute_intersection(p1, q1, p2, q2), np.array([0.5, 0.5])))
        p1 = np.array([0, 0])
        q1 = np.array([1, 1])
        p2 = np.array([0, 2])
        q2 = np.array([1, 1])
        self.assertTrue(np.array_equal(helpers._compute_intersection(p1, q1, p2, q2), np.array([1, 1])))
